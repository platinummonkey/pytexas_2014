...
{% block title %} - Movie - Corated Movie{% endblock %}

{% block content %}
<div class="row">
    <h2>Get Corated Movies</h2>
    <div class="row">
        <div class="col-sm-6">
            <h3>Model</h3>
            Simply use <code>movie.get_corated_movie(stars=stars, limit=limit)</code>.
        </div>
        <div class="col-sm-6">
            <h3>Code</h3>
            <pre>{{ code }}</pre>
